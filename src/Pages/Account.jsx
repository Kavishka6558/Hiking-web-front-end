  ...
  return (
    ...
    <div className='ml-4 md:ml-[150px]'>
        ...
        <div className="w-full md:w-96 h-auto md:h-96 bg-white shadow-xl relative md:absolute top-[400px] md:top-[400px] left-0 md:left-[250px] rounded-br-xl rounded-bl-xl">
            ...
            <h1 className='flex item-center ml-20 md:ml-36 mt-3 font-bold'><MdLogout className='mr-2 mt-1'/>Logout</h1>
        </div>
        <Button className='w-full md:w-96 h-12 md:h-20 bg-white rounded-xl shadow mt-6 md:top-[400px] mx-auto md:ml-24'>
            <h1 className="text-black text-base font-black font-['Inter'] capitalize">Edit details</h1>
        </Button>
    </div>
    <div className='ml-4 md:ml-[150px]'>
    ...
    <div className='ml-4 md:ml-[150px]'>
        <div className="w-full md:w-[1000px] h-auto md:h-[530px] bg-white rounded-xl shadow-xl mt-6 md:ml-[500px] md:absolute top-[350px]">
            ...
            <h1 className="text-black text-base font-normal leading-normal ml-[90%] md:ml-[900px] -mt-6">view all</h1>
            <Card className='w-full md:w-[950px] h-auto md:h-44 bg-white rounded-xl shadow-xl mt-5 mx-auto md:ml-6'>
                ...
                <Button className='ml-[80%] md:ml-[830px] bg-teal-800 w-20 h-9 mt-4 md:mt-10'>
                    <h1 className="text-white text-base font-normal leading-loose">View</h1>
                </Button>
            </Card>
    ...
    <div className='ml-4 md:ml-[1540px] mt-6 md:-mt-28'>
